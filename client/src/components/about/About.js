    ...
    return (
		...
		<div className="content-block">
			...
			<div className="section-area section-sp1 our-story">
				<div className="container">
					<div className="row align-items-center text-left d-flex">
						<div className="col-lg-12 col-md-12 heading-bx">
							<h2 className="m-b10 "><u>Welcome to the Zubnee Team</u></h2>
							<p className="text-left">
                                ...
                                The huge amount of talent that we have seen in Pakistan simply needs to be brought to light. How? By finding a Zubnee tutor with our advanced search options - without wasting time on confusing groups with loads of ads from agencies providing tutors. 
                                <br />
